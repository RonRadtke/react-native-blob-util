...
export default {
    ...
    getSDCardDir: old('getSDCardDir', 'media.sdCardDir', media.sdCardDir),
    getSDCardApplicationDir: old('getSDCardApplicationDir', 'media.sdCardApplicationDir', media.sdCardApplicationDir),
