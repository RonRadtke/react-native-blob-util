...
struct BlobUtilsSpec : winrt::Microsoft::ReactNative::TurboModuleSpec {
  ...
  static constexpr auto methods = std::tuple{
      Method<void(::React::JSValue, std::string, std::string, std::string, ::React::JSValue, ::React::JSValueArray, Callback<std::optional<::React::JSValue>, std::optional<std::string>, std::optional<std::string>, std::optional<::React::JSValue>>) noexcept>{0, L"fetchBlobForm"},
      Method<void(::React::JSValue, std::string, std::string, std::string, ::React::JSValue, std::string, Callback<std::optional<::React::JSValue>, std::optional<std::string>, std::optional<std::string>, std::optional<::React::JSValue>>) noexcept>{1, L"fetchBlob"},
      ...
      Method<void(std::string, Promise<::React::JSValue>) noexcept>{6, L"exists"},
      ...
      Method<void(std::string, std::string, bool, Promise<std::string>) noexcept>{9, L"writeStream"},
      Method<void(std::string, ::React::JSValueArray, Promise<void>) noexcept>{10, L"writeArrayChunk"},
      Method<void(std::string, std::string, Promise<void>) noexcept>{11, L"writeChunk"},
      Method<void(std::string, Promise<void>) noexcept>{12, L"closeStream"},
      Method<void(std::string, Promise<void>) noexcept>{13, L"unlink"},
      Method<void(::React::JSValueArray, Promise<void>) noexcept>{14, L"removeSession"},
      Method<void(std::string, Promise<::React::JSValueArray>) noexcept>{15, L"ls"},
      Method<void(std::string, Promise<::React::JSValue>) noexcept>{16, L"stat"},
      Method<void(std::string, Promise<::React::JSValueArray>) noexcept>{17, L"lstat"},
      Method<void(std::string, std::string, Promise<void>) noexcept>{18, L"cp"},
      Method<void(std::string, std::string, Promise<void>) noexcept>{19, L"mv"},
      ...
      Method<void(std::string, Promise<void>) noexcept>{24, L"cancelRequest"},
      Method<void(std::string, double, double) noexcept>{25, L"enableProgressReport"},
      Method<void(std::string, double, double) noexcept>{26, L"enableUploadProgressReport"},
      Method<void(std::string, std::string, double, double, Promise<std::string>) noexcept>{27, L"slice"},
      Method<void(std::string, std::optional<std::string>, Promise<::React::JSValueArray>) noexcept>{28, L"presentOptionsMenu"},
      Method<void(std::string, std::optional<std::string>, Promise<::React::JSValueArray>) noexcept>{29, L"presentOpenInMenu"},
      Method<void(std::string, std::optional<std::string>, Promise<::React::JSValueArray>) noexcept>{30, L"presentPreview"},
      Method<void(std::string, Promise<::React::JSValueArray>) noexcept>{31, L"excludeFromBackupKey"},
      Method<void(Promise<::React::JSValue>) noexcept>{32, L"df"},
      Method<void(std::string, std::string, std::optional<std::string>, Promise<void>) noexcept>{33, L"actionViewIntent"},
      Method<void(::React::JSValue, Promise<void>) noexcept>{34, L"addCompleteDownload"},
      Method<void(std::string, std::string, Promise<std::string>) noexcept>{35, L"copyToInternal"},
      Method<void(::React::JSValue, std::string, std::string, Promise<std::string>) noexcept>{36, L"copyToMediaStore"},
      Method<void(::React::JSValue, std::string, Promise<std::string>) noexcept>{37, L"createMediaFile"},
      Method<void(std::string, std::string, Promise<::React::JSValueArray>) noexcept>{38, L"getBlob"},
      Method<void(std::string, Promise<std::string>) noexcept>{39, L"getContentIntent"},
      Method<void(Promise<std::string>) noexcept>{40, L"getSDCardDir"},
      Method<void(Promise<std::string>) noexcept>{41, L"getSDCardApplicationDir"},
      Method<void(::React::JSValueArray, Promise<void>) noexcept>{42, L"scanFile"},
      Method<void(std::string, std::string, bool, Promise<std::string>) noexcept>{43, L"writeToMediaFile"},
      Method<void(std::string) noexcept>{44, L"addListener"},
      Method<void(double) noexcept>{45, L"removeListeners"},
  };
  ...
  static constexpr void ValidateModule() noexcept {
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          0,
          "fetchBlobForm",
          "    REACT_METHOD(fetchBlobForm) void fetchBlobForm(::React::JSValue && options, std::string taskId, std::string method, std::string url, ::React::JSValue && headers, ::React::JSValueArray && form, std::function<void(std::optional<::React::JSValue>, std::optional<std::string>, std::optional<std::string>, std::optional<::React::JSValue>)> const & callback) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(fetchBlobForm) static void fetchBlobForm(::React::JSValue && options, std::string taskId, std::string method, std::string url, ::React::JSValue && headers, ::React::JSValueArray && form, std::function<void(std::optional<::React::JSValue>, std::optional<std::string>, std::optional<std::string>, std::optional<::React::JSValue>)> const & callback) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          1,
          "fetchBlob",
          "    REACT_METHOD(fetchBlob) void fetchBlob(::React::JSValue && options, std::string taskId, std::string method, std::string url, ::React::JSValue && headers, std::string body, std::function<void(std::optional<::React::JSValue>, std::optional<std::string>, std::optional<std::string>, std::optional<::React::JSValue>)> const & callback) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(fetchBlob) static void fetchBlob(::React::JSValue && options, std::string taskId, std::string method, std::string url, ::React::JSValue && headers, std::string body, std::function<void(std::optional<::React::JSValue>, std::optional<std::string>, std::optional<std::string>, std::optional<::React::JSValue>)> const & callback) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          2,
          "createFile",
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          6,
          "exists",
          "    REACT_METHOD(exists) void exists(std::string path, ::React::ReactPromise<::React::JSValue> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(exists) static void exists(std::string path, ::React::ReactPromise<::React::JSValue> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          7,
          "writeFile",
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          9,
          "writeStream",
          "    REACT_METHOD(writeStream) void writeStream(std::string path, std::string withEncoding, bool appendData, ::React::ReactPromise<std::string> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(writeStream) static void writeStream(std::string path, std::string withEncoding, bool appendData, ::React::ReactPromise<std::string> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          10,
          "writeArrayChunk",
          "    REACT_METHOD(writeArrayChunk) void writeArrayChunk(std::string streamId, ::React::JSValueArray && withArray, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(writeArrayChunk) static void writeArrayChunk(std::string streamId, ::React::JSValueArray && withArray, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          11,
          "writeChunk",
          "    REACT_METHOD(writeChunk) void writeChunk(std::string streamId, std::string withData, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(writeChunk) static void writeChunk(std::string streamId, std::string withData, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          12,
          "closeStream",
          "    REACT_METHOD(closeStream) void closeStream(std::string streamId, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(closeStream) static void closeStream(std::string streamId, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          13,
          "unlink",
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          14,
          "removeSession",
          "    REACT_METHOD(removeSession) void removeSession(::React::JSValueArray && paths, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(removeSession) static void removeSession(::React::JSValueArray && paths, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          15,
          "ls",
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          16,
          "stat",
          "    REACT_METHOD(stat) void stat(std::string target, ::React::ReactPromise<::React::JSValue> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(stat) static void stat(std::string target, ::React::ReactPromise<::React::JSValue> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          17,
          "lstat",
          "    REACT_METHOD(lstat) void lstat(std::string path, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(lstat) static void lstat(std::string path, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          18,
          "cp",
          "    REACT_METHOD(cp) void cp(std::string src, std::string dest, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(cp) static void cp(std::string src, std::string dest, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          19,
          "mv",
          "    REACT_METHOD(mv) void mv(std::string path, std::string dest, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(mv) static void mv(std::string path, std::string dest, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          20,
          "mkdir",
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          24,
          "cancelRequest",
          "    REACT_METHOD(cancelRequest) void cancelRequest(std::string taskId, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(cancelRequest) static void cancelRequest(std::string taskId, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          25,
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          28,
          "presentOptionsMenu",
          "    REACT_METHOD(presentOptionsMenu) void presentOptionsMenu(std::string uri, std::optional<std::string> scheme, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(presentOptionsMenu) static void presentOptionsMenu(std::string uri, std::optional<std::string> scheme, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          29,
          "presentOpenInMenu",
          "    REACT_METHOD(presentOpenInMenu) void presentOpenInMenu(std::string uri, std::optional<std::string> scheme, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(presentOpenInMenu) static void presentOpenInMenu(std::string uri, std::optional<std::string> scheme, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          30,
          "presentPreview",
          "    REACT_METHOD(presentPreview) void presentPreview(std::string uri, std::optional<std::string> scheme, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(presentPreview) static void presentPreview(std::string uri, std::optional<std::string> scheme, ::React::ReactPromise<::React::JSValueArray> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          31,
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          32,
          "df",
          "    REACT_METHOD(df) void df(::React::ReactPromise<::React::JSValue> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(df) static void df(::React::ReactPromise<::React::JSValue> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          33,
          "actionViewIntent",
          "    REACT_METHOD(actionViewIntent) void actionViewIntent(std::string path, std::string mime, std::optional<std::string> chooserTitle, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(actionViewIntent) static void actionViewIntent(std::string path, std::string mime, std::optional<std::string> chooserTitle, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          34,
          "addCompleteDownload",
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          42,
          "scanFile",
          "    REACT_METHOD(scanFile) void scanFile(::React::JSValueArray && pairs, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(scanFile) static void scanFile(::React::JSValueArray && pairs, ::React::ReactPromise<void> &&result) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          43,
          "writeToMediaFile",
